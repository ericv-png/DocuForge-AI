    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_name') ? 'is-invalid' : '' }}" type="text" name="org_name" id="org_name" value="{{ old('org_name', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('footer_text') ? 'is-invalid' : '' }}" name="footer_text" id="footer_text">{!! old('footer_text') !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('registration_admin_approve') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="registration_admin_approve" id="registration_admin_approve" value="1" {{ old('registration_admin_approve', 0) == 1 || old('registration_admin_approve') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ai_service_provider_credentials') ? 'is-invalid' : '' }}" type="text" name="ai_service_provider_credentials" id="ai_service_provider_credentials" value="{{ old('ai_service_provider_credentials', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ai_processing_model') ? 'is-invalid' : '' }}" type="text" name="ai_processing_model" id="ai_processing_model" value="{{ old('ai_processing_model', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('api_status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="api_status" id="api_status" value="1" {{ old('api_status', 0) == 1 || old('api_status') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_file_processing_model') ? 'is-invalid' : '' }}" type="text" name="image_file_processing_model" id="image_file_processing_model" value="{{ old('image_file_processing_model', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('image_file_processing_credentials') ? 'is-invalid' : '' }}" name="image_file_processing_credentials" id="image_file_processing_credentials">{{ old('image_file_processing_credentials') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_file_processing_model') ? 'is-invalid' : '' }}" type="text" name="text_file_processing_model" id="text_file_processing_model" value="{{ old('text_file_processing_model', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('text_file_processing_credentials') ? 'is-invalid' : '' }}" name="text_file_processing_credentials" id="text_file_processing_credentials">{{ old('text_file_processing_credentials') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('mail_credentials') ? 'is-invalid' : '' }}" name="mail_credentials" id="mail_credentials">{{ old('mail_credentials') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('host_url') ? 'is-invalid' : '' }}" type="text" name="host_url" id="host_url" value="{{ old('host_url', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('moderation') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="moderation" id="moderation" value="1" {{ old('moderation', 0) == 1 || old('moderation') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('registration') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="registration" id="registration" value="1" {{ old('registration', 0) == 1 || old('registration') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_report_simu_process') ? 'is-invalid' : '' }}" type="number" name="max_report_simu_process" id="max_report_simu_process" value="{{ old('max_report_simu_process', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_data_source_simu_process') ? 'is-invalid' : '' }}" type="number" name="max_data_source_simu_process" id="max_data_source_simu_process" value="{{ old('max_data_source_simu_process', '0') }}" step="1">
