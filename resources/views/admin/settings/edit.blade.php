    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_name') ? 'is-invalid' : '' }}" type="text" name="org_name" id="org_name" value="{{ old('org_name', $setting->org_name) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('footer_text') ? 'is-invalid' : '' }}" name="footer_text" id="footer_text">{!! old('footer_text', $setting->footer_text) !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('registration_admin_approve') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="registration_admin_approve" value="0">
                    <input class="form-check-input" type="checkbox" name="registration_admin_approve" id="registration_admin_approve" value="1" {{ $setting->registration_admin_approve || old('registration_admin_approve', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="registration_admin_approve">{{ trans('cruds.setting.fields.registration_admin_approve') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ai_service_provider') ? 'is-invalid' : '' }}" name="ai_service_provider" id="ai_service_provider">
                    ...
                    @foreach(App\Models\Setting::AI_SERVICE_PROVIDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ai_service_provider', $setting->ai_service_provider) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ai_service_provider_credentials') ? 'is-invalid' : '' }}" type="text" name="ai_service_provider_credentials" id="ai_service_provider_credentials" value="{{ old('ai_service_provider_credentials', $setting->ai_service_provider_credentials) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ai_processing_model') ? 'is-invalid' : '' }}" type="text" name="ai_processing_model" id="ai_processing_model" value="{{ old('ai_processing_model', $setting->ai_processing_model) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('api_status') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="api_status" value="0">
                    <input class="form-check-input" type="checkbox" name="api_status" id="api_status" value="1" {{ $setting->api_status || old('api_status', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="api_status">{{ trans('cruds.setting.fields.api_status') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('image_file_processing') ? 'is-invalid' : '' }}" name="image_file_processing" id="image_file_processing">
                    ...
                    @foreach(App\Models\Setting::IMAGE_FILE_PROCESSING_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('image_file_processing', $setting->image_file_processing) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_file_processing_model') ? 'is-invalid' : '' }}" type="text" name="image_file_processing_model" id="image_file_processing_model" value="{{ old('image_file_processing_model', $setting->image_file_processing_model) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('image_file_processing_credentials') ? 'is-invalid' : '' }}" name="image_file_processing_credentials" id="image_file_processing_credentials">{{ old('image_file_processing_credentials', $setting->image_file_processing_credentials) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('text_file_processing') ? 'is-invalid' : '' }}" name="text_file_processing" id="text_file_processing">
                    ...
                    @foreach(App\Models\Setting::TEXT_FILE_PROCESSING_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('text_file_processing', $setting->text_file_processing) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_file_processing_model') ? 'is-invalid' : '' }}" type="text" name="text_file_processing_model" id="text_file_processing_model" value="{{ old('text_file_processing_model', $setting->text_file_processing_model) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('text_file_processing_credentials') ? 'is-invalid' : '' }}" name="text_file_processing_credentials" id="text_file_processing_credentials">{{ old('text_file_processing_credentials', $setting->text_file_processing_credentials) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('mail_credentials') ? 'is-invalid' : '' }}" name="mail_credentials" id="mail_credentials">{{ old('mail_credentials', $setting->mail_credentials) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('host_url') ? 'is-invalid' : '' }}" type="text" name="host_url" id="host_url" value="{{ old('host_url', $setting->host_url) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('moderation') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="moderation" value="0">
                    <input class="form-check-input" type="checkbox" name="moderation" id="moderation" value="1" {{ $setting->moderation || old('moderation', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="moderation">{{ trans('cruds.setting.fields.moderation') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('registration') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="registration" value="0">
                    <input class="form-check-input" type="checkbox" name="registration" id="registration" value="1" {{ $setting->registration || old('registration', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="registration">{{ trans('cruds.setting.fields.registration') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_report_simu_process') ? 'is-invalid' : '' }}" type="number" name="max_report_simu_process" id="max_report_simu_process" value="{{ old('max_report_simu_process', $setting->max_report_simu_process) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_data_source_simu_process') ? 'is-invalid' : '' }}" type="number" name="max_data_source_simu_process" id="max_data_source_simu_process" value="{{ old('max_data_source_simu_process', $setting->max_data_source_simu_process) }}" step="1">
