...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.extracted-datas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('extracted_data') ? 'is-invalid' : '' }}" name="extracted_data" id="extracted_data" required>{{ old('extracted_data') }}</textarea>
