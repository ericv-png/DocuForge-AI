                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('data_source_access')
                                        <a class="dropdown-item" href="{{ route('frontend.data-sources.index') }}">
                                            {{ trans('cruds.dataSource.title') }}
                                        </a>
                                    @endcan
                                    @can('data_category_access')
                                        <a class="dropdown-item" href="{{ route('frontend.data-categories.index') }}">
                                            {{ trans('cruds.dataCategory.title') }}
                                        </a>
                                    @endcan
                                    @can('extracted_data_access')
                                        <a class="dropdown-item" href="{{ route('frontend.extracted-datas.index') }}">
                                            {{ trans('cruds.extractedData.title') }}
                                        </a>
                                    @endcan
                                    @can('query_access')
                                        <a class="dropdown-item" href="{{ route('frontend.queries.index') }}">
                                            {{ trans('cruds.query.title') }}
                                        </a>
                                    @endcan
                                    @can('query_message_access')
                                        <a class="dropdown-item" href="{{ route('frontend.query-messages.index') }}">
                                    ...
                                    @can('moderation_access')
                                        <a class="dropdown-item" href="{{ route('frontend.moderations.index') }}">
                                            {{ trans('cruds.moderation.title') }}
                                        </a>
                                    @endcan
                                    @can('error_access')
                                        <a class="dropdown-item" href="{{ route('frontend.errors.index') }}">
