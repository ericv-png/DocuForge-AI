                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.reports.update", [$report->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reference" id="reference" value="{{ old('reference', $report->reference) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $report->name) }}">
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $report->description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tokens" id="tokens" value="{{ old('tokens', $report->tokens) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ai_model" id="ai_model" value="{{ old('ai_model', $report->ai_model) }}">
