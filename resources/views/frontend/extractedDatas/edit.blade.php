    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.extracted-datas.update", [$extractedData->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="source_file_id">{{ trans('cruds.extractedData.fields.source_file') }}</label>
                            <select class="form-control select2" name="source_file_id" id="source_file_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="excerpt" id="excerpt" value="{{ old('excerpt', $extractedData->excerpt) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="summary" id="summary">{{ old('summary', $extractedData->summary) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="extracted_data" id="extracted_data" required>{{ old('extracted_data', $extractedData->extracted_data) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tokens" id="tokens" value="{{ old('tokens', $extractedData->tokens) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ai_model" id="ai_model" value="{{ old('ai_model', $extractedData->ai_model) }}">
