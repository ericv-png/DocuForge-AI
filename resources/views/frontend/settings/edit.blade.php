                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="org_name" id="org_name" value="{{ old('org_name', $setting->org_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="footer_text" id="footer_text">{!! old('footer_text', $setting->footer_text) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="registration_admin_approve" id="registration_admin_approve" value="1" {{ $setting->registration_admin_approve || old('registration_admin_approve', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ai_service_provider_credentials" id="ai_service_provider_credentials" value="{{ old('ai_service_provider_credentials', $setting->ai_service_provider_credentials) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ai_processing_model" id="ai_processing_model" value="{{ old('ai_processing_model', $setting->ai_processing_model) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="api_status" id="api_status" value="1" {{ $setting->api_status || old('api_status', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="image_file_processing_model" id="image_file_processing_model" value="{{ old('image_file_processing_model', $setting->image_file_processing_model) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="image_file_processing_credentials" id="image_file_processing_credentials">{{ old('image_file_processing_credentials', $setting->image_file_processing_credentials) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="text_file_processing_model" id="text_file_processing_model" value="{{ old('text_file_processing_model', $setting->text_file_processing_model) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="text_file_processing_credentials" id="text_file_processing_credentials">{{ old('text_file_processing_credentials', $setting->text_file_processing_credentials) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="mail_credentials" id="mail_credentials">{{ old('mail_credentials', $setting->mail_credentials) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="host_url" id="host_url" value="{{ old('host_url', $setting->host_url) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="moderation" id="moderation" value="1" {{ $setting->moderation || old('moderation', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="registration" id="registration" value="1" {{ $setting->registration || old('registration', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_report_simu_process" id="max_report_simu_process" value="{{ old('max_report_simu_process', $setting->max_report_simu_process) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_data_source_simu_process" id="max_data_source_simu_process" value="{{ old('max_data_source_simu_process', $setting->max_data_source_simu_process) }}" step="1">
