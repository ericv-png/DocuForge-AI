...
{
    private $models = [
        'DataSource'    => 'cruds.dataSource.title',
        'ExtractedData' => 'cruds.extractedData.title',
        'Query'         => 'cruds.query.title',
        'QueryMessage'  => 'cruds.queryMessage.title',
        'Report'        => 'cruds.report.title',
    ];
